...
<div class="container">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#nuevo">Movil</a></li>
     <li><a data-toggle="tab" href="#menueditar">Asignado</a></li>
  </ul>
            ...
            <div class="x_panel">
                  ...
                  <div class="x_content">
                   <form class="form-horizontal form-label-left input_mask">
                        ...
                        <label for="carcamo" class="control-label col-md-4 col-sm-4 col-xs-12">Tipo</label>
                         ...
                         <select id="carcamo" class="form-control has-feedback-left" required>
                          <option data-cuenta="0"   value="0">--</option>
                            ...
                            <option data-cuenta="<?php echo $value->idtvar ?>" 
                              ...
                              <?php echo $selected ?>
                            value="<?php echo $value->idtvar ?>"><?php echo $value->valor." (".$value->idtvar .")"?></option>
                            <?php }  ?>
                          </select>
...
<div class="tabla_search"> </div>
    ...
    <div id="menueditar" class="tab-pane">
      <h3></h3>
       <div class="row">
                  ...
                  <div class="x_content">
                   <form class="form-horizontal form-label-left input_mask">
                        <div class="row">
                          <div class="col-md-6 col-xs-12"> 
                        <div class="form-group">
                        <label for="carcamo2" class="control-label col-md-4 col-sm-4 col-xs-12">Tipo</label>
                      <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                         <select id="carcamo2" class="form-control has-feedback-left" required>
                          <option data-cuenta="0"   value="0">--</option>
                            <?php 
                            foreach ($carcamos[0]->tipomovil as $key => $value) { 
                      ...
                      <div class="col-md-6 col-xs-12"> 
   <div class="form-group">
    <label for="reportrange2" class="control-label col-md-4 col-sm-4 col-xs-12">Fecha</label>
                      <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="reportrange2" placeholder="Fecha" maxlength="12"  >
                        <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>
                      </div>
                       </div>
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                       ...
                       <?php 
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          ...
                          <button type="button"  class="btn btn-success BuscarCarcamo2">Buscar
                          <span class="fa fa-search"></span>
                          </button>
                        </div>
                      </div>
...
console.log(fecha);
  ...
  if (carcamo==0) {
  new PNotify({  title: 'Dispositivo', text: 'Seleccione un tipo',type: 'warning',styling: 'bootstrap3' }); 
  }
  else{
...
$(".BuscarCarcamo2").click(function(event) {
      
      var turno = $("#turno_1").val();
 var carcamo = $("#carcamo2").val();
 var operador = $("#operador").val();
 var reportrange = $("#reportrange2").val();
console.log(turno);
//console.log(carcamo);
//console.log(operador);
//console.log(reportrange);
...
BuscarCarcamo2(carcamo,fecha[0].trim(),fecha[1].trim(),turno,operador,reportrange);
...
function BuscarCarcamo (carcamo,fecha1,fecha2,turno,operador,reportrange){
 $.ajax({
    ...
    // console.log(json);
     if (json.status==0) {
      new PNotify({ title: 'Alerta', text: 'registro no encontrado!',type: 'error',styling: 'bootstrap3'});
     }

    },
   error : function(xhr, status) {
       alert('Disculpe, existió un problema al Buscar Dispositivo');
       //$("#testuno").html('');
        console.log(status);
    },
...
function BuscarCarcamo2 (carcamo,fecha1,fecha2,turno,operador,reportrange){
 $.ajax({
      url : AjaxURL(),
    data : { action : "buscarCarcamo_tabla2",
       carcamo:carcamo,fecha1:fecha1,fecha2:fecha2,turno:turno,operador:operador
  },
     type : 'POST',
    dataType : 'HTML',
    beforeSend : function(xhr, status) {
    $(".tabla_search2").html(gifLoad());
    },
    success : function(json) {
    //$("#pageContentRegistrado").html(html);
    $(".tabla_search2").html(json);
     $("#reportrange2").val(reportrange);
    // console.log(json);
     if (json.status==0) {
      new PNotify({ title: 'Alerta', text: 'registro no encontrado!',type: 'error',styling: 'bootstrap3'});
     }
   ...
   error : function(xhr, status) {
       alert('Disculpe, existió un problema al Buscar asignaciones');
       //$("#testuno").html('');
        console.log(status);
    },
