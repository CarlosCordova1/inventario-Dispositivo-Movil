                   ...
                   <div class="clearfix"></div>
                    ...
                    <div class="clearfix"></div>
                       ...
                       <div class="col-md-6 col-xs-12"> 
                        <div class="form-group">
                        <label for="dm_a_equiponuevo" class="control-label col-md-4 col-sm-4 col-xs-12">SIM</label>
                      <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                        <input type="text" placeholder="N# SIM" class="form-control has-feedback-left equipotext3" id="dm_a_equiponuevo" list="lista1nuevo"  maxlength="100"  >
                         <datalist id="lista1nuevo"  required>
                          
                            <?php 
                            foreach ($carcamos[0]->simactivo as $key => $value) { 
                             
                              ?>
                            <option data-cuenta="<?php echo $value->sim ?>" 
                              data-idcuenta="<?php echo $value->sim ?>" 
                              <?php echo $selected ?>
                            data-val="<?php echo $value->sim ?>" value="<?php echo $value->sim?>">
                            <?php }  ?>
                          </datalist>
