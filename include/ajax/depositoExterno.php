...
<div class="container">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#nuevo">Deposito Externo</a></li>
    <!--<li><a data-toggle="tab" href="#menueditar">Nuevo Deposito Externo</a></li>-->
  </ul>

  <div class="tab-content">
    <div id="nuevo" class="tab-pane fade in active">
      <h3>depositos Externo</h3>
  ...
  <!--  <table   class="table table-striped table-bordered dt-responsive nowrap datatable-responsive datatable-buttons" cellspacing="0" width="100%">-->
   ...
   <tbody>
                        ...
                        <th><?php echo  number_format($value->montofacturado,2)?></th> 
                         ...
                         <th><?php echo $value->fechaauc?></th>
                           <th><?php echo $value->edocfm?></th>
                             <th>
							 <?php if ($value->edocfm!='FAC' and $value->edocfm!='ECA') {?>
                           ...
                           data-montovinculado="<?php echo $value->montofacturado?>"
                           ...
                           data-cuenta="<?php echo $value->CTACONT?>"
                            ...
                            data-estado="<?php echo $value->edocfm?>"
...
<!--
                          <th>
                           ...
                           <th>
                            ...
                            <?php echo  $value->OBSERVACIONES?> </p>
							</th>
                           </tr>
                             <?php } } ?>
                      </tbody>
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                         <select id="tipodeposito" class="form-control has-feedback-left" required>
                          ...
                          <?php
                           ...
                           <?php */ ?>
                           <option     value="EEX"> Entidad Externa </option>
                                 <?php }
