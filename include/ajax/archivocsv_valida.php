...
<div class="container">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#nuevocsv1">Validación</a></li>
...
<br>
  <div class="tab-content">
    <div id="nuevocsv" class="tab-pane fade in active">
	  ...
	  if ($api_detalle2[0]->lotesfile_valida->LoteValido)
						  {
						  	 echo '<div class="alert alert-success fade in alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
    <strong>Correcto! </strong> El lote no presenta errores</div>'; exit();
						  }
						  else{
						  	echo '<div class="alert alert-warning fade in alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
    <strong>Warning! </strong> El lote presenta errores en los siguientes registro</div>';
						  }
...
<th data-toggle="tooltip" title="Id del modelo de factura" >IDTMODFACMAN</th>
   ...
   <tbody>
                          ...
                          foreach ($api_detalle2[0]->lotesfile_valida->DatosConError as $key => $value) { 
...
loadcatalogo2(campo,text,$(this).parents(".editable_select"),iddato);
...
function loadcatalogo2(value,vtext,objeto,iddato){// se cambio el nombre para no cargar la misma funcion en diferentes archivos
	console.log(iddato);
	  $.ajax({
      url : AjaxURL(),
